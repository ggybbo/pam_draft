...
export class ScrumboardService implements Resolve<any> {
  ...
  getBoards(): Promise<any> {
    return new Promise((resolve, reject) => {
      this._httpClient
        .get(`http://${settings.apiUrl}:3000/classes`)
        .subscribe((response: any) => {
          this.boards = response;
          this.onBoardsChanged.next([
            {
              id: '32gfhaf2',
              ...
              lists: [
                ...
                {
                  id:
                    'ad7d.9fffac5dff412.c83bca6853767.8fd7549b2b1ca.ceda8a01774c4.a5cf3976e87e4.ce79eeeea',
                  name: 'Known Bugs',
                  idCards: [
              ...
              cards: [
                {
                  ...
                  description:
                    "Current generator doesn't support Node.js 6 and above.",
                  idAttachmentCover: '',
                  ...
                  checklists: [
                    {
                      ...
                      checkItems: [
                        ...
                        {
                          name:
                            'Replace event colors with Material Design colors',
                          checked: true
                        },
                        {
                  ...
                  comments: [
                    {
                      ...
                      message:
                        'We should be able to add moment.js without any problems',
                      time: '12 mins. ago'
                    },
                    {
                      idMember: '36027j1930450d8bf7b10158',
                ...
                },
                {
                  ...
                  checklists: [
                    {
                      id:
                        'dbfb.99bd0ad37dabc.e05046f0c824d.18f26bb524c96.78bebc8488634.240c0ee6a5e45.4cb872965',
                      name: 'Pages',
                      checkItemsChecked: 2,
                      checkItems: [
                        {
                  ...
                  comments: [
                    {
                      idMember: '36027j1930450d8bf7b10158',
                      message:
                        "This should be a medium priority bug, shouldn't it?",
                      time: 'now'
                    }
                  ],
                  activities: [],
                  ...
                  comments: [
                    {
                      idMember: '36027j1930450d8bf7b10158',
                      message:
                        'Currently we have two new designs ready to ship.',
                      time: 'now'
                    }
                  ],
                  activities: [],
                ...
                },
                {
                  ...
                  description:
                    'We need a service to monitor and recover failed APIs.',
                  idAttachmentCover: '',
                  idMembers: [
                    '36027j1930450d8bf7b10158',
                    '76027g1930450d8bf7b10958'
                  ...
                  checklists: [
                    {
                      id:
                        '6926.2b31d119e4a.889401e0ca7a0.13ad8ce2e569d.976e54e8b5d87.456afccd7e820.d6c77106a',
                      name: 'API Monitoring',
                      checkItemsChecked: 2,
                      checkItems: [
                        {
                        ...
                        {
                          name:
                            'Should be able to see different time periods on the same dashboard',
                          checked: true
                        },
                        {
                    ...
                    {
                      id:
                        '7c22.5261c7924387f.248e8b1d32205.003f7a9f501d1.1d48dcdbe8b23.8099dcc5f75a7.29a966196',
                      name: 'API Recovery',
                      checkItemsChecked: 1,
                      checkItems: [
                        {
                        ...
                        {
                          name:
                            'Immediate recovery options attached to the notifications',
                          checked: true
                        },
                        {
  ...
  updateBoard(): Promise<any> {
    return new Promise((resolve, reject) => {
      this._httpClient
        .post(`http://${settings.apiUrl}:3000` + this.board.id, this.board)
        .subscribe(response => {
          this.onBoardChanged.next(this.board);
          resolve(this.board);
        }, reject);
  ...
  createNewBoard(board): Promise<any> {
    return new Promise((resolve, reject) => {
      this._httpClient
        .post(`http://${settings.apiUrl}:3000` + board.id, board)
        .subscribe(response => {
          resolve(board);
        }, reject);
    });
