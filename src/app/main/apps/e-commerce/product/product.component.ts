...
export class EcommerceProductComponent implements OnInit, OnDestroy {
  ...
  createProductForm(): FormGroup {
    return this._formBuilder.group({
      ...
      images: [Object.values(this.product.images)],
  ...
  // addCats(event): void {
  //   console.log(this.product.addCategory(event));
  //   this.productForm.patchValue({
  //     categories: this.product.addCategory(event)
  //   });
  // }
  removeCats(category): void {
    this.productForm.patchValue({
      categories: this.product.removeCategory(category)
    });
  }
  // addTags(event): void {
  //   this.productForm.patchValue({
  //     tags: this.product.addTag(event)
  //   });
  // }
  removeTags(tag): void {
    this.productForm.patchValue({
      tags: this.product.removeTag(tag)
    });
  }
  ...
  onChange(event: ChangeEvent): void {
    ...
    this.productForm.patchValue({ description: event.editor.getData() });
